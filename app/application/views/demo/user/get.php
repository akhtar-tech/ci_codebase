        ...
        <div class="panel panel-flat">
            <div class="panel-heading">
                ...
                <div class="heading-elements">
                    <ul class="icons-list">
						<li class="label btn-warning"><a  href="<?php echo base_url() . $link . $controller.'edit/' . $row['id']; ?>">Edit</a></li>
            ...
            <div class="panel-body">
                ...
                <div class="text-right">
                    <a href="<?php echo base_url() . $link . $controller.'edit/' . $row['id']; ?>" type="submit" class="btn btn-xs btn-warning">Edit</a>
                    <a href="<?php echo base_url() . $link . $controller.'list'; ?>" type="submit" class="btn btn-xs btn-primary">List</a>
				</div>
			</div>
		</div>
        <?php echo form_close(); ?>

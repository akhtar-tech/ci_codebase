    ...
    <div class="panel-heading">
        ...
        <div class="heading-elements">
            <ul class="icons-list">
				...
				<!-- <li class="label label-primary"><a  href="<?php echo base_url() . $config['sub_directory']['dir_1']['link'] . $controller.'create'; ?>">Create</a></li>
				...
				<li class="label label-default"><a title="Click to load default page"  href="<?php echo base_url() . $config['sub_directory']['dir_1']['link'] . $controller.'list'; ?>">Clear</a></li>
			</ul>
		</div>
	</div>
                            ...
                            <ul class="icons-list">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <!-- <li><a onclick="deleteItem('<?php echo base_url() . $link . $controller.'delete/' . $row['id']; ?>', '<?php echo base_url() . $link . $controller.'list'; ?>')" href="javascript:{}"><i class="icon-trash"></i> Delete</a></li> -->
									</ul>
								</li>
							</ul>
						</td>

<div class="row">
	<div class="col-md-12">
		...
		<?php echo form_open_multipart($link . $controller . 'create', ['class' => 'form-horizontal']); ?>
		<div class="panel panel-flat">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
						<input name="file" type="file" class="file-styled" required>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="text-right">
					...
					<button type="submit" class="btn btn-xs btn-success">Submit <i class="icon-arrow-right14 position-right"></i></button>
				</div>
			</div>
